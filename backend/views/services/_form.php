...
<?= $form->field($model, 'city_id')->dropDownList(yii\helpers\ArrayHelper::map($cities, 'id', 'name'),['options' => [$model->city_id => ['Selected'=>true]]]) ?>
    ...
    <?= $form->field($model, 'type')->dropDownList([ 'Taxi services' => 'Taxi services', 'Money Exchanger' => 'Money Exchanger','Petrol pumps' => 'Petrol pumps','i-site centres' => 'i-site centres','Super markets' => 'Super markets','Shopping' => 'Shopping','Cinemas' =>'Cinemas' ], ['prompt' => '']) ?>
                        ...
                        <div class="file-preview-frame file-preview-initial" id="preview-image-<?= $val['id']?>" data-fileindex="init_1" data-template="image"><div class="kv-file-content">
                                ...
                                <div class="file-thumb-progress hide"><div class="progress">
                                    ...
                                    <div class="file-footer-buttons">
                                        <button type="button" class="kv-file-remove btn btn-xs btn-default"  onclick="deleteImage(<?= $val['id']?>, 'preview-image-<?= $val['id']?>', 'service' )" title="Remove" data-url="" data-key=""><i class="glyphicon glyphicon-trash text-danger"></i></button>
                                             </div>
